...
const generateAvatar = (name, username) => {
  // Use thumbs style which is gender-neutral and friendly
  // Alternative: use initials or shapes for completely neutral avatars
...
router.post('/register', [
  ...
  try {
    ...
    const avatar = generateAvatar(fullName, username);
